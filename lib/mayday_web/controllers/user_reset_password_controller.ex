defmodule MaydayWeb.UserResetPasswordController do
  ...
  def new(conn, _params) do
    render(conn, "new.html", page_title: "Forgot your password?")
  end

  def create(conn, %{"user" => %{"email" => email}}) do
    with %{role: role} = user when role != :deactivated <- Accounts.get_user_by_email(email) do
